...
#line 5 "while.y" // lalr1.cc:377

#include "semantics.hh"

#line 48 "while.tab.hh" // lalr1.cc:377
...
namespace yy {
#line 125 "while.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const type v, const location_type& l);
    ...
    static inline
    symbol_type
    make_T_POLY_LIT (const location_type& l);

    static inline
    symbol_type
    make_T_POLY (const location_type& l);

    static inline
    symbol_type
    make_T_EVAL (const location_type& l);
...
#line 808 "while.tab.hh" // lalr1.cc:377


// //                    "%code provides" blocks.
#line 9 "while.y" // lalr1.cc:377

int yylex(yy::parser::semantic_type* yylval, yy::parser::location_type* yylloc);

#line 816 "while.tab.hh" // lalr1.cc:377
